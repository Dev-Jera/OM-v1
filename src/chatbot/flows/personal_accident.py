...
premium_service = PersonalAccidentPremiumService()
...
class PersonalAccidentFlow:
    ...
    async def _step_personal_details(self, payload: Dict, data: Dict, user_id: str) -> Dict:
        ...
        if payload and "_raw" not in payload:
            ...
            # Middle name is optional and captured in quick quote if provided.
            # Do not re-collect it in post-quote steps.
            middle_name = quick_quote.get("middle_name", "")
        ...
        all_fields = [
            ...
            },
            {
                ...
                "options": [
                    ...
                    {"value": "Non-Ugandan", "label": "Non-Ugandan"},
                ],
            },
            {
    ...
    async def _step_final_confirmation(self, payload: Dict, data: Dict, user_id: str) -> Dict:
        """
        Step 8: Final Confirmation & Download Quote
        Show all collected data, calculated premium, and allow user to download quote before payment.
        """
        ...
        # Generate and register quote PDF if not already done
        ...
        if not quote_id:
            ...
            download_url = f"/api/v1/products/quotes/{quote_id}/download"
        ...
        resp = {
            "response": {
                ...
                "actions": [
                    {"type": "download", "label": "Download Quote (PDF)"},
